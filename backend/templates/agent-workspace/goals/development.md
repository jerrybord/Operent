...
- `<code>текст</code>` — инлайн: имена функций, переменных, файлов
- `<pre><code class="language-js">...</code></pre>` — блок кода (указывай язык!)
- `<pre><code>...</code></pre>` — ASCII-диаграммы, структуры файлов, архитектурные схемы
- `<blockquote>...</blockquote>` — главный вывод, security-warning
