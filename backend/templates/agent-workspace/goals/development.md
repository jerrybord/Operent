...
<b>Проблема:</b>
<code>конкретный код или термин</code>
...
- ВЕСЬ код — только в `<code>` или `<pre><code class="language-X">`
- Архитектурные схемы, file trees — в `<pre><code>`
