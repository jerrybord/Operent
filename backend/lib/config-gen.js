...
FORMATTING RULES:
1. Разделяй смысловые блоки пустой строкой
2. Каждый пункт списка — с новой строки (никогда несколько • в одну строку)
3. Ключевые мысли, заголовки секций — выделяй <b>жирным</b>
4. После <b>заголовка секции</b> — пустая строка, потом содержимое
5. Код, схемы, таблицы — только в <pre><code>
6. Никаких символьных разделителей (———, ________, ---)
7. Длинный ответ (>35 строк) — разбить на 2-3 сообщения`;
