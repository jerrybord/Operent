...
1. После каждого <b>Заголовка</b> — ОБЯЗАТЕЛЬНО пустая строка
2. Между секциями — пустая строка (пустая строка = единственный разделитель, НЕ символы вроде ——— или ---)
3. Каждый пункт (•) — на ОТДЕЛЬНОЙ строке, НИКОГДА несколько • в одну строку
4. Схемы, таблицы, UI-макеты — ТОЛЬКО в <pre><code>
5. Ответ > 35 строк — разбить на 2–3 сообщения
6. Монолитный текст без разбивки — НЕДОПУСТИМ
7. НИКАКИХ символьных разделителей вроде ——— или --- внутри или между абзацами`;
